...
import { buildError, isBoolean, isNumber, isString, Loose, normalizePath } from '@utils';
import { isAbsolute, join } from 'path';
import { isOutputTargetWww } from '../output-targets/output-utils';

export const validateDevServer = (config: Loose<d.Config>, diagnostics: d.Diagnostic[]) => {
