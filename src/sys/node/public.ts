 ...
 */
export declare function createNodeLogger(context: { process: any }): Logger;
 ...
 * @param context a context with NodeJS specific details used to create the system
 */
export declare function createNodeSys(context: { process: any }): CompilerSystem;
